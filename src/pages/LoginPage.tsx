...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Do NOT navigate here — RouteGuard reads appUser (populated after
      // onAuthStateChange + buildAppUser completes) and redirects correctly
      // based on role, activation state, and onboarding state.
    }
  };
